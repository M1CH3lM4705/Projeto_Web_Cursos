...
class Lesson(models.Model):
    ...
    course = models.ForeignKey(Course, related_name='lessons', verbose_name='Curso', on_delete=models.CASCADE)
...
class Material(models.Model):
    ...
    lesson = models.ForeignKey(Lesson, related_name='materials', verbose_name='Aula', on_delete=models.CASCADE)
...
class Enrollment(models.Model):
    ...
    status = models.IntegerField('Situação',
         choices=STATUS_CHOICES, default=1, blank=True)
    created_at = models.DateTimeField('Criado em', auto_now_add=True)
    updated_at = models.DateTimeField('Atualizado em', auto_now=True)
...
class Comment(models.Model):
    ...
    announcement = models.ForeignKey(Announcement, related_name='comments', verbose_name='Anúncio', on_delete=models.CASCADE)
...
models.signals.post_save.connect(post_save_announcement, sender=Announcement, 
